                        ...
                        <c:forEach items="${requestScope.recIndex}" var="recIndex">
                            <li class="col col50 mcol100">
                                <h3>
                                    ...
                                    <p>
                                        See More
                                        <%--<c:out escapeXml="false" value="${recIndex.description}"></c:out>--%>
                                    </p>
                                    <div class="tags">
                                    </div>
                                </li>
            ...
            <div class="swiper-container swiper-container-horizontal">
                <ul class="swiper-wrapper econtent">
                    <li class="pleft mcol100 swiper-slide " style="height: 564px;">
                        <div class="newconent">
                            <img src="resources/clients/images/jp_office_315x189.jpg" width="336" height="199" alt="Thông báo về việc chính thức đổi tên thương mại sang &quot;CO-WELL Châu Á&quot;">
                            <div class="boxNew">
                    ...
                    <li class="pleft mcol100 swiper-slide " style="height: 564px;">
                        <div class="newconent">
                            <img src="resources/clients/images/jp_office_315x189_2.jpg" width="336" height="199" alt="Thông báo hoàn thành việc mở rộng và cải tạo tầng 6 trung tâm phát triển tại Hà Nội">
                            <div class="boxNew">
                                <span style="background: #e04646" class="ebtn">
                                    Thông báo
                                </span>
                    ...
                    <li class="pleft mcol100 swiper-slide " style="height: 564px;">
                        <div class="newconent">
                            <img src="resources/clients/images/jp_office_315x189_4.jpg" width="336" height="199" alt="Thông báo về việc thay đổi địa chỉ văn phòng chi nhánh Đà Nẵng">
                            <div class="boxNew">
                                <span style="background: #e04646" class="ebtn">
                                    Thông báo
                                </span>
