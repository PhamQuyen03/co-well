    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <form method="post" action="http://localhost:8084/baitap/User/${requestScope.edit_user.id}">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input class="form-control" name="email_edit" placeholder="Enter Username" value="${requestScope.edit_user.name}">
                    </div>
                    <div class="form-group">
