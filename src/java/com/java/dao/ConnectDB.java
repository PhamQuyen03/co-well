...
public class ConnectDB {
    static String StrCon= "jdbc:sqlserver://DESKTOP-QKRBMNH\\SQLEXPRESS:1433;" + "databaseName=Cowell;user=quyen;password=123;useUnicode=true;characterEncoding=UTF-8";
